...
<html>
	...
	<head>
		...
		<title>Incluir matéria C - dados</title>
	</head>
	...
	<body>
		<div class="container">			
			...
			<form action="../IncluirMateriaC" method="post">  
				...
				<div class="well">
			   		<div class="row ">
				   		<div class="col-lg-8 form-group row" style="text-align:center">
			   				<div class="col-lg-4 form-group row" style="text-align:center">    						
