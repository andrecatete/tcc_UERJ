		...
		<div class="container">
			...
			<div class="row">				
				<div class="col-lg-4 dropdown">
				  	<button class="btn btn-dark btn-lg dropdown-toggle" type="button" data-toggle="dropdown"><h3>Categoria E</h3></button>
				...
				<div class="col-lg-8">
					<h3>2 dias por semana & 1 dia c/ 2 tempos e 1 dia c/ 1 tempo</h3> 
				</div>
			</div>	
			<br>
			<br>			
			<%@include file="incluirMateriaEDados.jsp" %>			
		</div>
