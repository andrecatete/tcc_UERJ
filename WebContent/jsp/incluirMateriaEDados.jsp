...
<html>
	...
	<head>
		...
		<title>Incluir matéria E - dados</title>
	</head>
	...
	<body>
		<div class="container">			
			...
			<form action="../IncluirMateriaE" method="post">  
				...
				<div class="well">
				   		<div class="row ">
		      				...
		      				<div class="col-lg-2 form-group row">		
		   					...
		   					<div class="col-lg-2 form-group row">		
	   							<select class="form-control form-control-lg form-group" id="semana" name="tempo1Dia2">							  		
							  		<option value="M1">M1</option>
							  		<option value="M2">M2</option>
							  		<option value="M3">M3</option>
							  		<option value="M4">M4</option>
