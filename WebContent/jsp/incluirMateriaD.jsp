		...
		<div class="container">
			...
			<div class="row">				
				<div class="col-lg-4 dropdown">
				  	<button class="btn btn-dark btn-lg dropdown-toggle" type="button" data-toggle="dropdown"><h3>Categoria D</h3></button>
				...
				<div class="col-lg-8">
					<h3>1 dia por semana & 4 tempos no dia</h3> 
				</div>
			</div>	
			<br>
			<br>			
			<%@include file="incluirMateriaDDados.jsp" %>			
		</div>
