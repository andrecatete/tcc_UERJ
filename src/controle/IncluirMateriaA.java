...
@WebServlet("/IncluirMateriaA")
public class IncluirMateriaA extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public IncluirMateriaA() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		materia.iniciarA('A', var1, App.id++, var2, var3, var4, var5, var6, var7, var8);
